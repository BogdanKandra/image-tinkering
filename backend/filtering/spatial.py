...
def blur(image, extra_inputs, parameters):
    ...
    Arguments:
        ...
        *parameters* (dictionary) -- a dictionary containing following keys:
            ...
            *type* (str, optional) -- the type of kernel to be used; possible
            values are *box* and *gaussian*; default value is *gaussian*

            *strength* (str) -- the strength of the blur effect; possible
            values are *weak*, *medium* and *strong*
...
def sharpen(image, extra_inputs, parameters):
    ...
    # Removing the blurred image from the original results in an image
    # containing only the details; adding the details image to the original
...
def edge(image, extra_inputs, parameters):
    ...
    Arguments:
        ...
        *parameters* (dictionary) -- a dictionary containing following keys:
            ...
            *method* (str) -- the type of edge detection algorithm to be applied;
            possible values are *laplacian*, *gradient*, *non-max suppression*, *canny*

            *pre-Blur* (str, optional) -- whether to apply blur to the input
    ...
    if method == 'laplacian':  # The Laplacian operator of the image is computed
        ...
        # surrounding pixel; otherwise, they are zeroed out
